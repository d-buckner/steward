...
import { Service, ServiceContainer, createServiceToken, ServiceClient } from '../src/index'
...
describe('ServiceContainer vs Direct ServiceClient', () => {
  ...
  describe('Event Forwarding Debugging', () => {
    it('should show what service instance the ServiceClient wraps', () => {
      ...
      // Debug: what does getServiceInstance return?
      const serviceInstance = (serviceClient as any).getServiceInstance()
      console.log('Service instance type:', serviceInstance.constructor.name)
      console.log('Service instance has eventBus:', 'eventBus' in serviceInstance)
      console.log('Service instance isInWorker:', serviceInstance.isInWorker)
